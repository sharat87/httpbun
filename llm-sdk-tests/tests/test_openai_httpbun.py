...
def test_openai_sync_response_structure(base_url: str):
    ...
    assert message.content == "This is a mock chat response from httpbun. I received your messages and I'm responding with this placeholder text."
...
def test_openai_sync_exact_field_count(base_url: str):
    ...
    expected_message_keys = {
        'content', 'refusal', 'role', 'annotations',
        'audio', 'function_call', 'tool_calls'
    }
...
async def test_openai_async_response(base_url: str):
    ...
    try:
        ...
        assert len(response.choices) == 1
        assert response.choices[0].message.content == "This is a mock chat response from httpbun. I received your messages and I'm responding with this placeholder text."
...
def test_openai_different_message(base_url: str):
    ...
    response = client.chat.completions.create(
        model="gpt-5-nano",
        messages=[
            {"role": "user", "content": "This is a different message"}
        ]
    )
...
def test_openai_response_serialization(base_url: str):
    ...
    assert response_dict['choices'][0]['message']['content'] == "This is a mock chat response from httpbun. I received your messages and I'm responding with this placeholder text."
    ...
    assert parsed['choices'][0]['message']['content'] == "This is a mock chat response from httpbun. I received your messages and I'm responding with this placeholder text."
